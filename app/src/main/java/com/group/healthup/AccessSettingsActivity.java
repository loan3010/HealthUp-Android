...
import com.group.healthup.databinding.ActivityAccessSettingsBinding;
import com.group.healthup.databinding.ItemSettingSwitchRowBinding;
...
public class AccessSettingsActivity extends AppCompatActivity {
    ...
    private void setupRows() {
        ...
        setupPermissionRow(binding.rowLibrary.getRoot(), "Cho phép truy cập Thư viện", Manifest.permission.READ_EXTERNAL_STORAGE);
    ...
    private void setupPermissionRow(android.view.View root, String title, String permission) {
        ...
        // Khi gạt nút, mở cài đặt ứng dụng để người dùng bật/tắt quyền (vì Android không cho phép tự động bật quyền qua code)
