...
public class Product implements Serializable {
    ...
    public static List<Product> getDummyProducts() {
        ...
        p1.setDescription("Sản phẩm chứa các loại hạt hạnh nhân, óc chó, hạt điều chất lượng cao.");
        p1.setPrice(150000);
        p1.setOriginalPrice(180000);
        ...
        p2.setDescription("Granola giòn rụm, giàu chất xơ và vitamin.");
        p2.setPrice(120000);
        p2.setOriginalPrice(150000);
        ...
        p3.setDescription("Xoài sấy dẻo tự nhiên, không đường hóa học.");
        p3.setPrice(85000);
        p3.setOriginalPrice(95000);
