...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        btnCartHeader.setOnClickListener(v -> navigateToCart());
        ...
        if (!grouped.isEmpty()) {
            ...
            for (Map.Entry<String, List<ProductVariant>> entry : grouped.entrySet()) {
                ...
                for (ProductVariant variant : variants) {
                    ...
                    chip.setOnClickListener(v -> selectVariantInGroup(chipGroup, variant));
            ...
            if (dividerVariants != null) dividerVariants.setVisibility(View.GONE);
            selectedVariant = null;
            updatePriceDisplay();
        }
    }

    private void selectVariantInGroup(com.google.android.material.chip.ChipGroup group, ProductVariant variant) {
    ...
    private void performBuyNow(int qty) {
        // Logic mua ngay
    }

    private void addToCartForProduct(Product product, ProductVariant variant, int qty) {
        CartHelper.addToCart(this, product, variant, qty, new CartHelper.CartCallback() {
            @Override
